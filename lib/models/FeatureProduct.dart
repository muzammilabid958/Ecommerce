...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    specialPrice =
        json.containsKey('special_price') ? json['special_price'] : "";
    formatedSpecialPrice = json.containsKey('formated_special_price')
        ? json['formated_special_price']
        : "";
    DiscountPercentage = json.containsKey('Discount_Percentage')
