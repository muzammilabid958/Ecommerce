...
//profileget();
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if(state == AppLifecycleState.paused) {
      Fluttertoast.showToast(msg:'AppLifecycleState state: Paused audio playback');
    
    }
    if(state == AppLifecycleState.resumed) {
      Fluttertoast.showToast(msg:'AppLifecycleState state: Resumed audio playback');
    }
          ...
          onTap: () async {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) {
                  return PlacePicker(
                    apiKey: "AIzaSyAdsDlFIxAwsDkXKt7wesv7XRmj3qN3RaY",
