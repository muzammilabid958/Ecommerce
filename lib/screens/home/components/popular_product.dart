...
class _PopularProductsState extends State<PopularProducts> {
  ...
  readJson() async {
    dynamic response = await APIService.jsonfile();
    setState(() {
      getjson = widgetjson.fromJson(response);
    });
  }
    ...
    return Column(
      children: [
        ...
        FutureBuilder<dynamic>(
          future: APIService.FeatureProductListing(token, "?featured=1"),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (snapshot.hasError) {
                ...
                FeatureProduct product = FeatureProduct.fromJson(snapshot.data);
                return Container(
